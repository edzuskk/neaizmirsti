<x-layout>
    <div style="max-width: 500px; margin: 0 auto;">
        <h1>Rediģēt neaizmirstuli</h1>
        <form class="aform" action="{{ route('update', $reminder->id) }}" method="POST">
            @csrf
        <div>
            <label for="reminder">😱Notikums</label>
            <input id="reminder" type="text" name="reminder" value="{{ $reminder->reminder }}" required>
        </div>
        <div>
